...
const Similar = () => {
  return (
    <div className='border rounded-sm p-2 w-1/4 m-5'>
          ...
          return (
            <div key={ind}>
              <div className="flex justify-between text-2xl font-medium m-5">
                <div> NFLX <span>$664.78</span></div>
                <Suggestion type='i' />
              </div>
              <div className="grid grid-cols-4 gap-10">
                <Title title="Environment Score" score="1.0" />
                <Title title="Sustainable Score" score="1.0" />
                <Title title="Governance Score" score="1.0" />
                <Title title="ESG Score" score="1.0" />
              </div></div>
          )
        })
        : null}
